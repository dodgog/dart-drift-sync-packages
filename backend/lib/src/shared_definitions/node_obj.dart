...
class NodeObj {
  ...
  static String? _getAttributeOrNull(
      List<Attribute> attributes, String attrName) {
    return attributes
  ...
  static String _getRequiredAttribute(
      List<Attribute> attributes, String attrName) {
    final value = _getAttributeOrNull(attributes, attrName);
    if (value == null) {
      throw NodeException('Required attribute missing: $attrName');
    }
    return value;
  }
...
class DocumentNodeObj extends NodeObj {
  ...
  static DocumentNodeObj fromAttributes(
    ...
    return DocumentNodeObj(
      ...
      author: NodeObj._getRequiredAttribute(attributes, 'author'),
      title: NodeObj._getRequiredAttribute(attributes, 'title'),
      url: NodeObj._getAttributeOrNull(attributes, 'url'),
    );
  }
...
class SimpleNodeObj extends NodeObj {
  ...
  static SimpleNodeObj? fromAttributes(
    ...
    List<String> items = [];
    try {
      final itemsJson = NodeObj._getRequiredAttribute(attributes, 'items');
