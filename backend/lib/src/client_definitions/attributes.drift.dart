...
import 'package:backend/src/client_definitions/attributes.drift.dart' as i1;
import 'package:drift/internal/modular.dart' as i2;
import 'package:backend/src/client_definitions/events.drift.dart' as i3;
...
class AttributesDrift extends i2.ModularAccessor {
  AttributesDrift(i0.GeneratedDatabase db) : super(db);
  ...
  i3.EventsDrift get eventsDrift => this.accessor(i3.EventsDrift.new);
